...
# Comprobación de parches faltantes
...
# Identificación de parches extra (no requeridos)
...
$parchesCorrectos = $totalRequeridos - $kbsFaltantes.Count

$porcentajeCumplimiento = [math]::Round(
    ($parchesCorrectos / $totalRequeridos) * 100, 0
)
