...
Entramos en la GPO de Configuración de usuarios dinámica y la editamos. Debemos seguir la siguiente ruta: Configuración de usuario > Preferencias > Configuración de Windows > Accesos directos.

![alt text](img16.png)

Agregamos un nuevo acceso directo

![alt text](img17.png)

En la pestaña de general debe aparecer así configurado.

![alt text](img18.png)

En la pestaña de común tendremos que marcar la casilla indicada y hacer clic en Destinatarios

![alt text](img19.png)

Dentro de Destinatarios, hacemos clic sobre nuevo y seleccionamos un grupo de seguridad

![alt text](img20.png)

Seleccionamos el grupo de Alumnos de dam
...
Creamos la GPO que nos indica el ejercicio.

![alt text](img22.png)

Dentro de esta GPO tendremos que editarla y seguir la siguiente ruta: Configuración del equipo > Directivas > Configuración de Windows > Configuración de seguridad > Directivas locales > Opciones de seguridad, y aquí habilitaremos la directiva que dice: Apagado: borrar el archivo de paginación de la memoria virtual

![alt text](img23.png)

Una vez hecho esto, en el Administrador de directivas de grupo, bajamos y encontramos Filtros WMI, hacemos clic derecho sobre él y seleccionamos "Nuevo". Le damos el nombre que queramos.

![alt text](img24.png)

Ahora nos dirigimos a consultas y realizaremos la siguiente

![alt text](img25.png)

Le ponemos ese número ya que está en bytes.

Una vez creado el filtro, nos dirigimos a la GPO que acabamos de crear y en la parte inferior derecha nos sale Filtrado WMI, y le aplicamos el que creamos anteriormente
...
Ahora editamos la GPO que acabamos de crear y seguimos la siguiente ruta: Configuración del equipo > Directivas > Config. de Windows > Config. de seguridad > Directivas locales > Opciones de seguridad.
Y aquí iremos a la directiva que dice Control de cuentas de usuario: detectar instalaciones de aplicaciones.

![alt text](img28.png)

Después de la edición de esa directiva, creamos otro filtro, el cuál debe estar así configurado

![alt text](img29.png)

Y se lo vinculamos a la GPO que creamos.
