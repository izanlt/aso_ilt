...
Y la tenemos creada con su nombre
![alt text](img7.png)

Creamos las UO principales dentro del raíz
![alt text](img8.png)

Ya tenemos la estructura con los usuarios
![alt text](img9.png)

Ahora crearemos los grupos y metemos a los usuarios en su grupo correspondiente
![alt text](img10.png)

Metemos a los grupos de dam y afi en el grupo de alumnos_general
![alt text](img11.png)

Este sería un ejemplo de como deben estar configurados los horarios de los alumnos
![alt text](img12.png)

Y la de los profesores debería verse así
![alt text](img13.png)